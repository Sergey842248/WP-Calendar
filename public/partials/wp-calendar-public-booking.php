<?php
/**
 * Booking form template for the public-facing side of the site.
 */
    ...
    <?php else : ?>
        ...
        <form id="wp-calendar-booking-form" method="post">
            ...
            <div class="form-row">
                ...
                <input type="text" id="appointment_date" name="appointment_date" class="wp-calendar-datepicker" required>
            </div>
